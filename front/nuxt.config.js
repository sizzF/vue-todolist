module.exports = {
    ...
    vuetify: {},
    axios: {
      browserBaseURL: process.env.NODE_ENV === 'production' ? 'http://3.134.207.122:3086' : 'http://localhost:3086',
      baseURL: process.env.NODE_ENV === 'production' ? 'http://3.134.207.122:3086' : 'http://localhost:3086',
        https: false,
    },
    moment: {
        locales: ['ko'],
